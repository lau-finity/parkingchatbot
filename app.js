...
function receivedAuthentication(event) {
  ...
  sendTextMessage(senderID, "Welcome to Waterloo's Parking chatbot! We'll tell you the real-time availability for all permit-required lots.\n (enter \'lot [C, N, W, or X]\')");
}
